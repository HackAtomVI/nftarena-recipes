...
PADDEDVEST=$(<./items/$PADDEDVEST_ID.json)
GAMBESON=$(<./items/$GAMBESON_ID.json)
CHAINMAIL=$(<./items/$CHAINMAIL_ID.json)
BRIGANDINE=$(<./items/$BRIGANDINE_ID.json)
PLATEARMOR=$(<./items/$PLATEARMOR_ID.json)
