...
pylonsd tx pylons create-recipe $GAME_NAME mintarmor mintarmor "mint a random weapon" $VERSION '[{"coins": [{"denom": "'$TOKEN_NAME_EXT'", "amount": "100"}]}]' '[]' '{"coinOutputs": [],"itemOutputs": ['$PADDEDVEST','$GAMBESON','$CHAINMAIL','$BRIGANDINE','$PLATEARMOR'],"itemModifyOutputs":[]}' '[{"entryIDs": ["'$PADDEDVEST_ID'"],"weight": 1},{"entryIDs": ["'$GAMBESON_ID'"],"weight": 1},{"entryIDs": ["'$CHAINMAIL_ID'"],"weight": 1},{"entryIDs": ["'$BRIGANDINE_ID'"],"weight": 1},{"entryIDs": ["'$PLATEARMOR_ID'"],"weight": 1}]' 1 true "" --from $ACC_NAME